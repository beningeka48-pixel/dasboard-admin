...
<style>
    ...
    * {
    ...
    .sidebar-menu {
        ...
        /*
         * Menu mengambil ruang yang tersedia.
         * Jika menu terlalu panjang, menu akan scroll.
         */
    ...
    .sidebar-bottom {
         ...
         * Dengan flex, bagian ini selalu berada di bawah
         * dan tidak menutupi menu.
         */
    ...
    html[data-theme="dark"] .citizen-card,
...
<div class="sidebar">
    ...
    <a href="{{ route('admin.dashboard') }}"
       class="brand">
        ...
        DINKAN<span>(Digitalisasi Nu Kracak)</span>
    ...
    <div class="topbar
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                @yield(
                    'page-description',
                    'Welcome to KracakNu Administration'
                )
